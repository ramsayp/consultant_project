...
Every memory file must be written to **both** locations:
...
Both the file and the `MEMORY.md` index must be updated in each location. The repo copy survives a machine reformat.
