...
- [Lock app nav personalisation](feedback_app_nav_personalisation.md) — always set isNavPersonalizationDisabled:true on every Lightning App; users must not control their own tabs
